...
import com.evpa.chsp.repository.PaymentRepository;
import com.evpa.chsp.repository.search.PaymentSearchRepository;
...
public class PaymentResource {
    ...
    public ResponseEntity<List<Payment>> searchPayments(@RequestParam String query, @ApiParam Pageable pageable)
        ...
        Page<Payment> page = paymentSearchRepository.search(queryStringQuery(query), pageable);
